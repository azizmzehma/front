...
@Component({
  selector: 'app-add-project-front',
  templateUrl: './add-project-front.component.html',
  styleUrls: ['./add-project-front.component.css']
})
export class AddProjectFrontComponent {
