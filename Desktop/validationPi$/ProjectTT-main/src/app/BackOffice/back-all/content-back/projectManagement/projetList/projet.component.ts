...
export class ProjetComponent implements OnInit {
  ...
  // Propriétés pour les critères de recherche
  searchTitle: string = '';
  searchDateDebut: Date | null = null;
  searchDateFinPrevu: Date | null = null;
  searchEtatProject: EtatProject | null = null;
  ...
  initChart(): void {
    ...
    const maxCount = Math.max(...stateData) + 1;
  ...
  // Méthode de recherche multicritère
